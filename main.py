...
def parse_args_config():
    ...
    parser.add_argument("--max_train_steps", default=200000, type=int)
    parser.add_argument("--pretraining_steps", default=50000, type=int)
    ...
    parser.add_argument("--val_metric", default="SISDR", type=str)
    parser.add_argument("--scheduler_type", default="constant", type=str)
    parser.add_argument("--dropout_rate", type=float, default=1.0)
    parser.add_argument("--adv_training", default=True, action="store_true")
